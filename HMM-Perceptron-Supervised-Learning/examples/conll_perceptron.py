...
if __name__ == "__main__":
    ...
    for lr in lrs:
        for decoder in decoders:
            model = StructuredPerceptron(verbose=True, max_iter=10, decode=decoder, lr_exponent=lr)
    ...
    model = StructuredPerceptron(verbose=True, max_iter=20, decode=best_decoder, lr_exponent=best_lr)
